  ...
  return {
    ...
    hooks: {
      'astro:config:setup': async ({
        ...
        const { SITE, I18N, METADATA, APP_BLOG, APP_CATEGORY, APP_TAG, APP_AUTHOR, UI, ANALYTICS } = configBuilder(rawJsonConfig);
            ...
            plugins: [
              {
                ...
                load(id) {
                  if (id === resolvedVirtualModuleId) {
                    ...
                    export const APP_CATEGORY = ${JSON.stringify(APP_CATEGORY)};
                    export const APP_TAG = ${JSON.stringify(APP_TAG)};
                    export const APP_AUTHOR = ${JSON.stringify(APP_AUTHOR)};
